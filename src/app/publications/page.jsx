...
const PublicationsPage = () => {
    ...
    const openModal = () => {
        // Vérifie si l'utilisateur est un freelancer sans abonnement
                            ...
                            <div key={pub._id} className="bg-white-100 dark:bg-white-200 rounded-xl shadow-lg overflow-hidden transition-all duration-300">
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="flex justify-end mt-4">
                                        <button className="font-geist-mono px-4 py-2 bg-green-500 hover:bg-green-600 text-white-50 rounded-lg transition-colors">
                                            Contacter
                                        </button>
                                    </div>
                                </div>
