...
export default function Stepper({
  ...
  backButtonProps = {},
  nextButtonProps = {},
  completeButtonProps = {}, // Nouvelle prop
  backButtonText = "Back",
  nextButtonText = "Continue",
  completeButtonText = "Complete", // Nouvelle prop
  ...
  return (
    <div
      className="flex min-h-screen flex-1 flex-col items-center justify-center  mx-4 md:mx-0"
      {...rest}
    >
      <div
        className={`mx-auto w-full max-w-md rounded-3xl shadow-xl shadow-white-300 bg-white-200 ${stepCircleContainerClassName}`}
        style={{ border: "1px solid #5c4d7c" }}
      >
        <div
...
function StepIndicator({
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: "#302546", color: "#f9f8fc" },
          active: { scale: 1, backgroundColor: "#f9f8fc", color: "#f9f8fc" },
          complete: { scale: 1, backgroundColor: "#f9f8fc", color: "#3b82f6" },
        }}
...
function StepConnector({ isComplete }) {
  const lineVariants = {
    ...
    complete: { width: "100%", backgroundColor: "#302546" },
  };

  return (
    <div className="relative mx-2 h-0.5 flex-1 overflow-hidden rounded bg-white-50">
      <motion.div
